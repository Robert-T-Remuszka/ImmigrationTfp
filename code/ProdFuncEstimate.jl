...
x0 = vcat(p0.ρ, p0.θ, p0.γᶠ, p0.Δ, p0.Γ, p0.αᶠ, p0.αᵈ, p0.ι, p0.ιₛ[2 : end], p0.ιₜ[2: end]); # Fixed effects have leading zeros
...
ι = x_star[8], ιₛ = vcat(0., x_star[9 : 7 + N]), ιₜ = vcat(0., x_star[8 + N : end]));
