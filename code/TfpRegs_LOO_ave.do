...
loc graphs "ZResponse_Iv1990_LOO_ave ZResponse_Iv1990_LOO_ave_F"
/*************************************************
Some Cleaning
*************************************************/
...
frame Estimates {
    ...
    * Confidence intervals - 95% for LOO
    ...
    ytitle("{&eta}{subscript:Z}") xtitle("Horizon") legend(off) yline(0, lc(black%50) lp(solid)) name(ZResponse_Iv1990_LOO_ave)
...
frame Estimates {
    ...
    yline(10,lc(black%70) lp(dash)) legend(off) b1title("Horizon") ytitle("First Stage F") name(ZResponse_Iv1990_LOO_ave_F)
