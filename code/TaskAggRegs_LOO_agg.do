...
loc graphs "LResponse_Iv1990_LOO_agg LResponse_Iv1990_LOO_agg_F"
...
frame Estimates {
    ...
    * Confidence intervals - 95% for LOO
    ...
    ytitle("{&eta}{subscript:L}") xtitle("Horizon") legend(off) yline(0, lc(black%50) lp(solid)) name(LResponse_Iv1990_LOO_agg)
...
frame Estimates {
    ...
    yline(10,lc(black%70) lp(dash)) legend(off) b1title("Horizon") ytitle("First Stage F") name(LResponse_Iv1990_LOO_agg_F)
