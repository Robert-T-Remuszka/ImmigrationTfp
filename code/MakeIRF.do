...
EstimateIRF Z , endogenous(fg) instruments(Bartik_1990) depvarlags(4) absorb(year state) wt(emp) impulse(fg) ///
...
EstimateIRF L , endogenous(fg) instruments(Bartik_1990) depvarlags(4) absorb(year state) wt(emp) impulse(fg) ///
...
EstimateIRF Z , endogenous(fg) instruments(Bartik_1990_LOO) depvarlags(4) absorb(year state) wt(emp) impulse(fg) ///
...
EstimateIRF L , endogenous(fg) instruments(Bartik_1990_LOO) depvarlags(4) absorb(year state) wt(emp) impulse(fg) ///
