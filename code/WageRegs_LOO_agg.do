...
loc graphs "Wage00Response_Iv1990_LOO_agg Wage01Response_Iv1990_LOO_agg Wage00Response_Iv1990_LOO_agg_F Wage01Response_Iv1990_LOO_agg_F"
...
frame Estimates {
    ...
    * Confidence intervals - 95% for LOO
    ...
    ytitle("{&epsilon}{subscript:F}") xtitle("Horizon") legend(off) yline(0, lc(black%50) lp(solid)) name(Wage01Response_Iv1990_LOO_agg)
    ...
    ytitle("{&epsilon}{subscript:D}") xtitle("Horizon") legend(off) yline(0, lc(black%50) lp(solid)) name(Wage00Response_Iv1990_LOO_agg)
...
frame Estimates {
    ...
    yline(10,lc(black%70) lp(dash)) legend(off) b1title("Horizon") ytitle("First Stage F") name(Wage01Response_Iv1990_LOO_agg_F)

    graph bar FDomesticIv1990_LOO if h > -1, over(h) bar(1, color("0 147 245") fcolor("0 147 245")) ylab(0(20)180, nogrid labsize(small)) ///
    yline(10,lc(black%70) lp(dash)) legend(off) b1title("Horizon") ytitle("First Stage F") name(Wage00Response_Iv1990_LOO_agg_F)
